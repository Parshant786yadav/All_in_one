...
from hirewise.resume_reader import extract_text

from hirewise.resume_parser import extract_resume_details
from hirewise.job_matcher import rank_candidates
...
# When mounted at /hirewise (e.g. from root main.py), prefix is set by main.py WSGI wrapper
app.config['APPLICATION_ROOT'] = '/hirewise'
